    ...
    socket.on('tictactoe-start-game',({board,currentTurn,player1Symbol,player2Symbol})=>{
        ...
        player1Mobile.innerHTML='('+player1Symbol+') '+player1Mobile.innerHTML;
        player2Mobile.innerHTML='('+player2Symbol+') '+player2Mobile.innerHTML;
    });